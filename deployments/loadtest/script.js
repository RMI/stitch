...
// to Prometheus via remote-write (configured by `make loadtest` env), tagged
// `testid=<git-sha>` so runs from different PRs can be compared in Grafana.
//
...
export const options = {
  ...
  thresholds: {
    ...
    // exit 99, which would fail `make loadtest`). Promote latency to a gate
