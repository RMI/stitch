...
export const FIELD_META = {
  ...
  production_conventionality: { label: "Production Conventionality", section: "production" },
  primary_hydrocarbon_group:  { label: "Primary Hydrocarbon Group",  section: "production" },
  reservoir_formation:        { label: "Reservoir Formation",        section: "production" },
  discovery_year:             { label: "Discovery Year",             section: "production" },
  production_start_year:      { label: "Production Start Year",      section: "production" },
